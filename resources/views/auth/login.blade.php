            ...
            <div class="row full-height justify-content-center">
                <div class="col-12 text-center align-self-center py-5">
                    <div class="section pb-5 pt-5 pt-sm-2 text-center">
                        <h6 class="mb-0 pb-3"><span class="span1">Log In </span><span class="span2"
                                onclick="window.location.href='/register'">Sign Up</span></h6>
                                ...
                                <div class="card-front">
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <p class="mb-0 mt-4 text-center"><a href="{{ url('/404') }}"
                      ...
                      <form method="POST" action="{{ route('register.perform') }}">
                        <h4 class="mb-3 pb-3">Sign Up</h4>
											...
											<div class="form-group mt-2">
												<input type="tel" class="form-style" name="phonenumber" placeholder="Phone Number">
